  ...
  List<List<jts.Coordinate>> chain(SegmentList segments) {
    ...
    for (var seg in segments) {
      ...
      if (Epsilon().pointsSame(pt1, pt2)) {
        log("PolyBool: Warning: Zero-length segment detected; your epsilon is probably too small or too large");
        continue;
      }
...
class Match {
  ...
  Match({this.index = 0, this.matchesHead = false, this.matchesPt1 = false});
}
